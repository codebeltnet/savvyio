...
> [!IMPORTANT]
> Version 2.2.0 of Savvy I/O will be the last version to support .NET 7.<br/>
...
| <font size="2">[Savvyio.Extensions.DependencyInjection.Newtonsoft.Json](https://www.nuget.org/packages/Savvyio.Extensions.DependencyInjection.Newtonsoft.Json/)</font> | ![vNext](https://img.shields.io/nuget/vpre/Savvyio.Extensions.DependencyInjection.Newtonsoft.Json?logo=nuget) | ![Stable](https://img.shields.io/nuget/v/Savvyio.Extensions.DependencyInjection.Newtonsoft.Json?logo=nuget) | ![Downloads](https://img.shields.io/nuget/dt/Savvyio.Extensions.DependencyInjection.Newtonsoft.Json?color=blueviolet&logo=nuget) |
...
| <font size="2">[Savvyio.Extensions.DependencyInjection.Text.Json](https://www.nuget.org/packages/Savvyio.Extensions.DependencyInjection.Text.Json/)</font> | ![vNext](https://img.shields.io/nuget/vpre/Savvyio.Extensions.DependencyInjection.Text.Json?logo=nuget) | ![Stable](https://img.shields.io/nuget/v/Savvyio.Extensions.DependencyInjection.Text.Json?logo=nuget) | ![Downloads](https://img.shields.io/nuget/dt/Savvyio.Extensions.DependencyInjection.Text.Json?color=blueviolet&logo=nuget) |
