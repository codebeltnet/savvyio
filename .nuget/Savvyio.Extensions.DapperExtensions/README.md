...
Extend the Savvy I/O core assemblies with support for [Dapper](https://github.com/DapperLib/Dapper) and automapping of Plain Old CLR Objects (POCO) by [DapperExtensions](https://github.com/tmsmith/Dapper-Extensions).
