...
Extend the Savvy I/O support for Microsoft Dependency Injection with [Microsoft Entity Framework Core](https://github.com/dotnet/efcore) implementation - optimized for Domain Driven Design and Event Sourcing.
