...
[assembly: SuppressMessage("Critical Code Smell", "S1006:Method overrides should not change parameter defaults", Justification = "By design; Predicate needs to be set on setup delegate.", Scope = "member", Target = "~M:Savvyio.Extensions.EFCore.DefaultEfCoreDataAccessObject`1.ReadAsync(System.Action{Savvyio.Extensions.EFCore.EfCoreOptions{`0}})~System.Threading.Tasks.Task{`0}")]
