...
namespace Savvyio
{
    ...
    {
        public MediatorDescriptor(IList<IHierarchy<object>> discoveredCommandHandlers, IList<IHierarchy<object>> discoveredEventHandlers, IList<IHierarchy<object>> discoveredDomainEventHandlers)
        {
        ...
        private static void AppendHandler(StringBuilder builder, IGrouping<Tuple<string, string>, IHierarchy<object>> group)
        {
            builder.AppendLine();
