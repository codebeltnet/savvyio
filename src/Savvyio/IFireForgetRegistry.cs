...
{
    /// <summary>
    /// Specifies a Fire-and-Forget/In-Only MEP registry that store delegates responsible of handling type <typeparamref name="TModel"/>.
    /// </summary>
    /// <typeparam name="TModel">The type of the model to store in the registry.</typeparam>
    /// <seealso cref="IFireForgetActivator{TModel}"/>
    public interface IFireForgetRegistry<in TModel>
    {
        /// <summary>
        /// Registers the specified delegate <paramref name="handler"/>.
        /// </summary>
        /// <typeparam name="T">The type that implements <typeparamref name="TModel"/>.</typeparam>
