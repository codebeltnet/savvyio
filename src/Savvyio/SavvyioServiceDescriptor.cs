...
namespace Savvyio
{
    public class SavvyioServiceDescriptor
    {
        public SavvyioServiceDescriptor(IEnumerable<IGrouping<Type, KeyValuePair<Type, List<IHierarchy<object>>>>> discoveredServices, IEnumerable<Type> serviceTypes)
        {
