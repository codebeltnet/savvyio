...
[assembly: SuppressMessage("Naming", "CA1710:Identifiers should have correct suffix", Justification = "By design - Dictionary suffix confuses context.", Scope = "type", Target = "~T:Savvyio.EventDriven.Messaging.CloudEvents.ICloudEvent`1")]
