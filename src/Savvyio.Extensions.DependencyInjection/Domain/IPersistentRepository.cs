...
namespace Savvyio.Extensions.DependencyInjection.Domain
{
    ...
    public interface IPersistentRepository<TEntity, TKey, TMarker> : IPersistentRepository<TEntity, TKey>, IWritableRepository<TEntity, TKey, TMarker>, IReadableRepository<TEntity, TKey, TMarker>, ISearchableRepository<TEntity, TKey, TMarker>, IDeletableRepository<TEntity, TKey, TMarker> where TEntity : class, IIdentity<TKey>
    {
    }
}
