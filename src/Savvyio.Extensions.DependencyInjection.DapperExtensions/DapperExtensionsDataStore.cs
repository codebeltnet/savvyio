...
{
    /// <summary>
    /// Provides a default implementation of the <see cref="IPersistentDataStore{T,TOptions}"/> interface to support multiple implementations that is tailored for Plain Old CLR Objects (POCO) usage by DapperExtensions.
    /// </summary>
