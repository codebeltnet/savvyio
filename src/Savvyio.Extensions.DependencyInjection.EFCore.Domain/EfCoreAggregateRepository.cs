...
namespace Savvyio.Extensions.DependencyInjection.EFCore.Domain
{
    ...
    public class EfCoreAggregateRepository<TEntity, TKey, TMarker> : EfCoreRepository<TEntity, TKey>, IPersistentRepository<TEntity, TKey, TMarker>
        where TEntity : class, IEntity<TKey>, IAggregateRoot<IDomainEvent>
    {
        /// <summary>
