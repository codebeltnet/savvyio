...
namespace Savvyio.Extensions.Text.Json.EventDriven.Messaging.Cryptography
{
    public class IntegrationEventExtensionsTest : Test
    {
        ...
        public void ToMessage_Sign_ShouldSerializeAndDeserialize_MemberCreated_UsingConcreteType()
        {
            ...
            var sut4 = JsonMarshaller.Default.Deserialize<SignedMessage<MemberCreated>>(json);
