...
namespace Savvyio.Extensions.SimpleQueueService.EventDriven
{
    ...
    public class AmazonEventBusNewtonsoftJsonSerializerContextTestLocalStack : HostTest<HostFixture>
    {
        ...
        public AmazonEventBusNewtonsoftJsonSerializerContextTestLocalStack(HostFixture fixture, ITestOutputHelper output) : base(fixture, output)
        {
        ...
        public async Task PublishAsync_MemberCreated_OneTime()
        {
            ...
            var sut2 = (IsLinux ? "newtonsoft-member-events-one" : "newtonsoft-member-events-one.fifo").ToSnsUri(o => o.AccountId = "000000000000");
        ...
        public async Task PublishAsync_MemberCreated_ThousandTimes()
        {
            var messages = Generate.RangeOf(1000, _ =>
            {
                ...
                return new MemberCreated(Generate.RandomString(10), email).ToMessage((IsLinux ? "newtonsoft-member-events-many" : "newtonsoft-member-events-many.fifo").ToSnsUri(o => o.AccountId = "000000000000"), nameof(MemberCreated));
            });
