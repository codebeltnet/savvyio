...
namespace Savvyio.Extensions.SimpleQueueService.Commands
{
    ...
    public class AmazonCommandQueueNewtonsoftJsonSerializerContextTestLocalStack : HostTest<HostFixture>
    {
        ...
        public AmazonCommandQueueNewtonsoftJsonSerializerContextTestLocalStack(HostFixture fixture, ITestOutputHelper output) : base(fixture, output)
        {
