...
namespace Savvyio.Extensions.QueueStorage.EventDriven
{
    ...
    public class AzureEventBusNewtonsoftJsonSerializerContextTest : HostTest<HostFixture>
    {
        ...
        public AzureEventBusNewtonsoftJsonSerializerContextTest(HostFixture fixture, ITestOutputHelper output) : base(fixture, output)
        {
