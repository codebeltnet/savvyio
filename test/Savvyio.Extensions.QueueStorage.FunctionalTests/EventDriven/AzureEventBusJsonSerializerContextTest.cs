...
namespace Savvyio.Extensions.QueueStorage.EventDriven
{
    ...
    public class AzureEventBusJsonSerializerContextTest : HostTest<ManagedHostFixture>
    {
        ...
        {
            var queueName = $"savvyio-events-{Platform}-{BuildType}";
            ...
            {
                o.TopicEndpoint = "https://savvyio-events-win-debug.swedencentral-1.eventgrid.azure.net/api/events".ToUri();
                o.KeyCredential = new AzureKeyCredential(Configuration["Azure:EventGrid:Windows:Debug:Key"]!);
            });
            ...
            {
                o.TopicEndpoint = "https://savvyio-events-win-release.swedencentral-1.eventgrid.azure.net/api/events".ToUri();
                o.KeyCredential = new AzureKeyCredential(Configuration["Azure:EventGrid:Windows:Release:Key"]!);
            });
            ...
            {
                o.TopicEndpoint = "https://savvyio-events-linux-debug.swedencentral-1.eventgrid.azure.net/api/events".ToUri();
                o.KeyCredential = new AzureKeyCredential(Configuration["Azure:EventGrid:Linux:Debug:Key"]!);
            });
            ...
            {
                o.TopicEndpoint = "https://savvyio-events-linux-release.swedencentral-1.eventgrid.azure.net/api/events".ToUri();
                o.KeyCredential = new AzureKeyCredential(Configuration["Azure:EventGrid:Linux:Release:Key"]!);
            });
        }
    }
}
